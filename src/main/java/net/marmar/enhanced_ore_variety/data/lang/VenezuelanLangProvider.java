...
public class VenezuelanLangProvider extends LanguageProvider {
    public VenezuelanLangProvider(PackOutput output) {
        super(output, EnhancedOreVariety.MOD_ID, "es_ve");
    }

    @Override
    protected void addTranslations() {
        //Tabs
        add("tabs." + EnhancedOreVariety.MOD_ID + ".ore_variants", "Variaciones de menas");
