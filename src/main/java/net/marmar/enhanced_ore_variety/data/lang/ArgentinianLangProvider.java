...
public class ArgentinianLangProvider extends LanguageProvider {
    public ArgentinianLangProvider(PackOutput output) {
        super(output, EnhancedOreVariety.MOD_ID, "es_ar");
    }
