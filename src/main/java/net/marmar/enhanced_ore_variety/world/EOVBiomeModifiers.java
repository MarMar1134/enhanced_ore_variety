...
public class EOVBiomeModifiers {
    ...
    public static void removeVanillaOres(BootstapContext<BiomeModifier> pContext){
        ...
        //Coal
        pContext.register(REMOVE_COAL_UPPER_ORE, new ForgeBiomeModifiers.RemoveFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(OrePlacements.ORE_COAL_UPPER)),
                Set.of(GenerationStep.Decoration.UNDERGROUND_ORES)));
        pContext.register(REMOVE_COAL_LOWER_ORE, new ForgeBiomeModifiers.RemoveFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
        ...
        //Gold
        pContext.register(REMOVE_GOLD_ORE_EXTRA, new ForgeBiomeModifiers.RemoveFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(OrePlacements.ORE_GOLD_EXTRA)),
                Set.of(GenerationStep.Decoration.UNDERGROUND_ORES)));
        pContext.register(REMOVE_GOLD_ORE, new ForgeBiomeModifiers.RemoveFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
        ...
        //Redstone
        pContext.register(REMOVE_REDSTONE_ORE, new ForgeBiomeModifiers.RemoveFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(OrePlacements.ORE_REDSTONE)),
                Set.of(GenerationStep.Decoration.UNDERGROUND_ORES)));
        pContext.register(REMOVE_REDSTONE_LOWER_ORE, new ForgeBiomeModifiers.RemoveFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(OrePlacements.ORE_REDSTONE_LOWER)),
                Set.of(GenerationStep.Decoration.UNDERGROUND_ORES)));

        //Lapis lazuli
        pContext.register(REMOVE_LAPIS_ORE, new ForgeBiomeModifiers.RemoveFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(OrePlacements.ORE_LAPIS)),
                Set.of(GenerationStep.Decoration.UNDERGROUND_ORES)));
        pContext.register(REMOVE_LAPIS_BURIED_ORE, new ForgeBiomeModifiers.RemoveFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(OrePlacements.ORE_LAPIS_BURIED)),
                Set.of(GenerationStep.Decoration.UNDERGROUND_ORES)));

        //Emerald
        pContext.register(REMOVE_EMERALD_ORE, new ForgeBiomeModifiers.RemoveFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
    ...
    public static void addEnhancedOres(BootstapContext<BiomeModifier> pContext){
        var placedFeatures = pContext.lookup(Registries.PLACED_FEATURE);
        var biomes = pContext.lookup(Registries.BIOME);

        //Coal
        pContext.register(ADD_COAL_UPPER_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(EOVPlacedFeatures.UPPER_COAL_ORES_PLACED)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        pContext.register(ADD_COAL_LOWER_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(EOVPlacedFeatures.LOWER_COAL_ORES_PLACED)),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        //Copper
        pContext.register(ADD_COPPER_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(EOVPlacedFeatures.COPPER_ORES_PLACED)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        pContext.register(ADD_COPPER_LARGE_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(EOVPlacedFeatures.LARGE_COPPER_ORES_PLACED)),
               GenerationStep.Decoration.UNDERGROUND_ORES));

        //Iron
        pContext.register(ADD_IRON_UPPER_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(EOVPlacedFeatures.UPPER_IRON_ORES_PLACED)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        pContext.register(ADD_IRON_MIDDLE_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(EOVPlacedFeatures.MIDDLE_IRON_ORES_PLACED)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        pContext.register(ADD_IRON_SMALL_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(EOVPlacedFeatures.SMALL_IRON_ORES_PLACED)),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        //Gold
        pContext.register(ADD_GOLD_ORE_EXTRA, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                ...
                GenerationStep.Decoration.UNDERGROUND_ORES));
        pContext.register(ADD_GOLD_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
        ...
        //Redstone
        pContext.register(ADD_REDSTONE_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(EOVPlacedFeatures.REDSTONE_ORES_PLACED)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        pContext.register(ADD_REDSTONE_LOWER_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(EOVPlacedFeatures.LOWER_REDSTONE_ORES_PLACED)),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        //Lapis lazuli
        pContext.register(ADD_LAPIS_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(EOVPlacedFeatures.LAPIS_ORES_PLACED)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        pContext.register(ADD_LAPIS_BURIED_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(EOVPlacedFeatures.LAPIS_BURIED_ORES_PLACED)),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        //Emerald
        pContext.register(ADD_EMERALD_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_MOUNTAIN),
                HolderSet.direct(placedFeatures.getOrThrow(EOVPlacedFeatures.EMERALD_ORES_PLACED)),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        //Diamond
        pContext.register(ADD_DIAMOND_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(EOVPlacedFeatures.DIAMOND_ORES_PLACED)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        pContext.register(ADD_DIAMOND_LARGE_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(EOVPlacedFeatures.LARGE_DIAMOND_ORES_PLACED)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        pContext.register(ADD_DIAMOND_BURIED_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, ResourceLocation.fromNamespaceAndPath(EnhancedOreVariety.MOD_ID, name));
    }
}
